...
import { MEDICAMENTOS_MAESTROS, textoMedicamentoParaBusqueda } from "./data/catalogoFarmacologicoUnificado.js?v=20260911-modafinil-substances-lab-v1";
import { CITOCROMOS_FARMACOLOGICOS } from "./data/citocromosFarmacologicos.js?v=20260911-modafinil-substances-lab-v1";
...
const CAPITULOS_CIE10_CODIGOS_COMPLETOS = new Set(["A", "B", "C", "D", "E", "F", "G", "H", "I"]);
...
const datosBibliotecaListos = libraryRoot
    ? import("./data/catalogoDiagnosticos.js?v=20260904-biblioteca-cie10-h-v1").then((diagnosticosModule) => {

...
function renderGraficaLinea(id, valores, sufijo = "ms") {
  ...
  nodo.innerHTML = `<svg viewBox="0 0 100 100" preserveAspectRatio="none"><polyline points="${puntos}" fill="none" stroke="#529866" stroke-width="2" vector-effect="non-scaling-stroke"/><line x1="0" y1="96" x2="100" y2="96" stroke="rgba(148,163,184,.25)" vector-effect="non-scaling-stroke"/></svg><small>Max: ${Math.round(max)} ${sufijo}</small>`;
}

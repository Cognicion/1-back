...
INGREDIENTES_EXTRA.push(
  { id: "sumatriptan", nombre: "Sumatriptan", sinonimos: ["sumatriptan", "sumatriptán", "imitrex"], clases: ["triptan", "serotoninergico"], riesgos: { serotoninergico: 1, cardiovascular: 1 } },
  { id: "rizatriptan", nombre: "Rizatriptan", sinonimos: ["rizatriptan", "rizatriptán", "maxalt"], clases: ["triptan", "serotoninergico"], riesgos: { serotoninergico: 1, cardiovascular: 1 } },
...
const INTERACCIONES_EXTRA = [
  ...
  { id: "cyp3a4_inhibidor_sustrato", clasesA: ["inhibidor_cyp3a4"], clasesB: ["sustrato_cyp3a4"], severidad: "moderada", titulo: "Inhibidor CYP3A4 + sustrato CYP3A4", efecto: "Puede aumentar exposición del sustrato y eventos adversos.", recomendacion: "Revisar dosis, toxicidad esperada y alternativas.", categoria: "metabolica_cyp", tipoInteraccion: "farmacocinetica", evidencia: "potencial" },
...
INTERACCIONES_EXTRA.push(
  ...
  },
  {
    ...
    severidad: "alta",
    titulo: "Combinación de fármacos serotoninérgicos",
    mecanismo: "Ambos incrementan la neurotransmisión serotoninérgica.",
    efecto: "Aumenta el riesgo de síndrome serotoninérgico, efectos adversos gastrointestinales, ansiedad, insomnio, temblor, hiperreflexia y otros eventos serotoninérgicos.",
    recomendacion: "Evitar duplicidad terapéutica salvo indicación especializada. Si se realiza cambio cruzado, documentar estrategia, dosis, tiempo de lavado y vigilancia clínica.",
    categoria: "serotoninergica",
    tipoInteraccion: "serotoninergica",
    evidencia: "regla_de_clase"
  },
  {
    id: "isrs_isrs_duplicidad",
    clasesA: ["isrs"],
    clasesB: ["isrs"],
    severidad: "moderada",
    titulo: "Duplicidad terapéutica: ISRS + ISRS",
    mecanismo: "Dos inhibidores selectivos de la recaptura de serotonina producen una carga serotoninérgica terapéutica aditiva.",
    efecto: "Puede aumentar efectos adversos serotoninérgicos y no suele aportar beneficio si no existe una estrategia de transición especializada.",
    recomendacion: "Evitar la combinación sostenida salvo indicación especializada; documentar cambio cruzado, dosis, tiempo de lavado y vigilancia clínica.",
    categoria: "duplicidad_terapeutica",
    tipoInteraccion: "farmacodinamica",
    evidencia: "regla_de_clase"
  },
  {
    id: "isrs_irsn_serotoninergico",
    clasesA: ["isrs"],
    clasesB: ["irsn"],
    severidad: "moderada",
    titulo: "ISRS + IRSN: carga serotoninérgica aditiva",
    mecanismo: "Ambas clases aumentan la neurotransmisión serotoninérgica.",
    efecto: "Puede aumentar efectos serotoninérgicos y otros eventos adversos dependientes de dosis.",
    recomendacion: "Usar solo con indicación especializada, dosis prudentes y vigilancia clínica.",
    categoria: "serotoninergica",
    tipoInteraccion: "farmacodinamica",
    evidencia: "regla_de_clase"
  },
  {
    id: "isrs_triciclico_serotoninergico",
    clasesA: ["isrs"],
    clasesB: ["triciclico"],
    severidad: "moderada",
    titulo: "ISRS + tricíclico: carga serotoninérgica y metabólica",
    mecanismo: "La combinación puede sumar actividad serotoninérgica y alterar la exposición del tricíclico según la molécula y el CYP implicado.",
    efecto: "Puede aumentar efectos serotoninérgicos, anticolinérgicos, cardiovasculares y de sedación.",
    recomendacion: "Usar solo con indicación especializada y revisar dosis, CYP, ECG y vigilancia clínica.",
    categoria: "serotoninergica",
    tipoInteraccion: "farmacodinamica",
    evidencia: "regla_de_clase"
  },
  {
    ...
    clasesB: ["qt"],
    severidad: "alta",
    titulo: "Combinación de fármacos con riesgo de QT",
    mecanismo: "Los fármacos comparten potencial de prolongación del intervalo QT y el efecto puede ser aditivo.",
    efecto: "Aumenta el riesgo de QT prolongado y arritmia ventricular, especialmente con dosis altas, bradicardia o alteraciones electrolíticas.",
    recomendacion: "Revisar alternativas, dosis, ECG, potasio y magnesio según el riesgo individual.",
    categoria: "qt",
    tipoInteraccion: "QT",
    evidencia: "regla_de_clase"
  },
  {
    id: "depresor_snc_depresor_snc",
    clasesA: ["depresor_snc"],
    clasesB: ["depresor_snc"],
    severidad: "moderada",
    titulo: "Combinación de depresores del SNC",
    mecanismo: "Los efectos sedantes y depresores respiratorios pueden sumarse.",
    efecto: "Puede aumentar somnolencia, deterioro psicomotor, caídas y depresión respiratoria.",
    recomendacion: "Usar la menor dosis necesaria, evitar alcohol y vigilar estado de alerta y respiración.",
    categoria: "depresora_snc",
    tipoInteraccion: "farmacodinamica",
    evidencia: "regla_de_clase"
  },
  {
    id: "inhibidor_cyp2d6_sustrato_cyp2d6",
    clasesA: ["inhibidor_cyp2d6"],
    clasesB: ["sustrato_cyp2d6"],
    severidad: "moderada",
    titulo: "Inhibidor CYP2D6 + sustrato CYP2D6",
    mecanismo: "La inhibición de CYP2D6 puede aumentar la exposición del fármaco sustrato.",
    efecto: "Puede aumentar efectos adversos del sustrato; la magnitud depende del inhibidor, dosis, duración y capacidad metabólica individual.",
    recomendacion: "Revisar ficha técnica del par concreto, dosis, respuesta y eventos adversos; ajustar solo con seguimiento clínico.",
    categoria: "metabolica_cyp",
    tipoInteraccion: "farmacocinetica",
    evidencia: "regla_de_clase"
  },
  {
    id: "inhibidor_cyp3a4_estatina",
    clasesA: ["inhibidor_cyp3a4"],
    clasesB: ["estatina"],
    severidad: "alta",
    titulo: "Inhibidor CYP3A4 + estatinas sensibles",
    mecanismo: "La inhibición de CYP3A4 puede aumentar la exposición de estatinas metabolizadas por esta vía.",
    efecto: "Puede aumentar el riesgo de mialgias, miopatía o rabdomiólisis según la estatina, dosis y contexto clínico.",
    recomendacion: "Revisar la estatina concreta, considerar alternativa o ajuste temporal y vigilar síntomas musculares y CK si está indicado.",
    categoria: "metabolica_cyp",
    tipoInteraccion: "farmacocinetica",
    evidencia: "regla_de_clase"
  },
  { id: "serotoninergico_triptan", clasesA: ["isrs", "irsn", "triciclico", "serotoninergico"], clasesB: ["triptan"], severidad: "moderada", titulo: "Serotonergico + triptan", mecanismo: "La suma de actividad serotoninergica puede aumentar la senal serotoninergica central.", efecto: "Riesgo poco frecuente pero clinicamente relevante de sindrome serotoninergico.", recomendacion: "Usar con vigilancia y educar sobre agitacion, temblor, hiperreflexia, diaforesis, fiebre o diarrea.", categoria: "serotoninergica", tipoInteraccion: "serotoninergica", evidencia: "documentada_en_etiquetado" },
  { id: "bupropion_tramadol_convulsivo", ingredientesA: ["bupropion"], ingredientesB: ["tramadol"], severidad: "alta", titulo: "Bupropion + tramadol: umbral convulsivo", mecanismo: "Ambos pueden favorecer convulsiones por mecanismos farmacodinamicos aditivos.", efecto: "Puede aumentar el riesgo de convulsiones y sumar riesgo serotoninergico.", recomendacion: "Evitar si existen alternativas; revisar antecedentes convulsivos, dosis y otros farmacos que reduzcan el umbral convulsivo.", categoria: "convulsiva", tipoInteraccion: "farmacodinamica", evidencia: "documentada_en_etiquetado" },
  { id: "fenobarbital_inductor_sustrato", ingredientesA: ["fenobarbital"], clasesB: ["sustrato_cyp3a4", "anticoagulante", "anticonceptivo_hormonal"], severidad: "moderada", titulo: "Fenobarbital: induccion enzimatica", mecanismo: "Fenobarbital induce enzimas y transportadores y puede reducir la exposicion de sustratos sensibles.", efecto: "Puede disminuir el efecto de algunos psicofarmacos, anticoagulantes y anticonceptivos.", recomendacion: "Revisar el sustrato concreto, eficacia clinica y alternativas; ajustar solo con seguimiento especializado.", categoria: "metabolica_cyp", tipoInteraccion: "farmacocinetica", evidencia: "documentada_en_etiquetado" },
  { id: "anticoagulante_heparina_anticoagulante", ingredientesA: ["heparina", "enoxaparina"], clasesB: ["anticoagulante", "antiagregante", "aine"], severidad: "alta", titulo: "Anticoagulacion combinada: riesgo hemorragico", mecanismo: "La anticoagulacion y/o inhibicion plaquetaria aditiva reduce la hemostasia.", efecto: "Aumenta el riesgo de sangrado mayor, gastrointestinal o intracraneal.", recomendacion: "Evitar duplicidad no indicada; confirmar indicacion, dosis, funcion renal y vigilancia de sangrado.", categoria: "hemorragica", tipoInteraccion: "farmacodinamica", evidencia: "documentada_en_etiquetado" },
  { id: "clozapina_mielosupresor", ingredientesA: ["clozapina"], clasesB: ["mielosupresor", "antimetabolito", "inmunosupresor"], severidad: "alta", titulo: "Clozapina + farmaco mielosupresor", mecanismo: "La suma de efectos sobre la medula osea puede reducir el recuento de neutrofilos.", efecto: "Mayor riesgo de neutropenia, agranulocitosis e infeccion grave.", recomendacion: "Evitar salvo indicacion especializada y coordinar biometria hematica/neutrofilos.", categoria: "hematologica", tipoInteraccion: "farmacodinamica", evidencia: "documentada_en_etiquetado" }
);

export const ESCALAS_PSIQUIATRICAS = [
  ...
  },
  {
    id: "saps",
    nombre: "SAPS",
    area: "Psicosis - sintomas positivos",
    tipoEscala: "psiquiatrica",
    descripcion: "Scale for the Assessment of Positive Symptoms. Evaluacion clinica de sintomas positivos psicoticos por dominios.",
    introduccion: "Califique cada manifestacion segun entrevista, observacion y expediente reciente. 0 = ausente, 5 = severo/extremo.",
    rango: "0-170",
    puntajeMaximo: 170,
    dominiosEvaluados: ["Alucinaciones", "Delirios", "Conducta bizarra", "Trastorno formal positivo del pensamiento"],
    opciones: ["Ausente", "Dudoso/minimo", "Leve", "Moderado", "Marcado", "Severo/extremo"],
    valores: [0, 1, 2, 3, 4, 5],
    puntosCorte: [
      { max: 20, texto: "Sintomas positivos bajos o minimos; integrar con entrevista clinica" },
      { max: 60, texto: "Sintomas positivos leves a moderados" },
      { max: 110, texto: "Sintomas positivos marcados" },
      { max: 170, texto: "Sintomas positivos severos; requiere integracion clinica estrecha" }
    ],
    items: [
      { texto: "Alucinaciones auditivas.", dominio: "Alucinaciones" },
      { texto: "Voces que comentan.", dominio: "Alucinaciones" },
      { texto: "Voces que conversan entre si.", dominio: "Alucinaciones" },
      { texto: "Alucinaciones somaticas o tactiles.", dominio: "Alucinaciones" },
      { texto: "Alucinaciones olfatorias.", dominio: "Alucinaciones" },
      { texto: "Alucinaciones visuales.", dominio: "Alucinaciones" },
      { texto: "Valoracion global de alucinaciones.", dominio: "Alucinaciones" },
      { texto: "Delirios persecutorios.", dominio: "Delirios" },
      { texto: "Delirios de celos.", dominio: "Delirios" },
      { texto: "Delirios de pecado o culpa.", dominio: "Delirios" },
      { texto: "Delirios de grandeza.", dominio: "Delirios" },
      { texto: "Delirios religiosos.", dominio: "Delirios" },
      { texto: "Delirios somaticos.", dominio: "Delirios" },
      { texto: "Ideas o delirios de referencia.", dominio: "Delirios" },
      { texto: "Delirios de ser controlado.", dominio: "Delirios" },
      { texto: "Lectura del pensamiento.", dominio: "Delirios" },
      { texto: "Difusion del pensamiento.", dominio: "Delirios" },
      { texto: "Insercion del pensamiento.", dominio: "Delirios" },
      { texto: "Robo del pensamiento.", dominio: "Delirios" },
      { texto: "Valoracion global de delirios.", dominio: "Delirios" },
      { texto: "Vestimenta o apariencia inusual.", dominio: "Conducta bizarra" },
      { texto: "Conducta social o sexual inapropiada.", dominio: "Conducta bizarra" },
      { texto: "Conducta agresiva o agitada.", dominio: "Conducta bizarra" },
      { texto: "Conducta repetitiva o estereotipada.", dominio: "Conducta bizarra" },
      { texto: "Valoracion global de conducta bizarra.", dominio: "Conducta bizarra" },
      { texto: "Descarrilamiento o asociaciones laxas.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Tangencialidad.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Incoherencia.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Ilogicidad.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Circunstancialidad.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Presion del habla.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Habla distraible.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Asociaciones por sonido o clang.", dominio: "Trastorno formal positivo del pensamiento" },
      { texto: "Valoracion global del trastorno formal positivo del pensamiento.", dominio: "Trastorno formal positivo del pensamiento" }
    ]
  },
  {
    id: "sans",
    nombre: "SANS",
    area: "Psicosis - sintomas negativos",
    tipoEscala: "psiquiatrica",
    descripcion: "Scale for the Assessment of Negative Symptoms. Evaluacion clinica de sintomas negativos por dominios.",
    introduccion: "Califique cada manifestacion segun entrevista, observacion y funcionamiento reciente. 0 = ausente, 5 = severo/extremo.",
    rango: "0-125",
    puntajeMaximo: 125,
    dominiosEvaluados: ["Aplanamiento afectivo", "Alogia", "Avolicion-apatia", "Anhedonia-asocialidad", "Atencion"],
    opciones: ["Ausente", "Dudoso/minimo", "Leve", "Moderado", "Marcado", "Severo/extremo"],
    valores: [0, 1, 2, 3, 4, 5],
    puntosCorte: [
      { max: 20, texto: "Sintomas negativos bajos o minimos; integrar con contexto clinico" },
      { max: 50, texto: "Sintomas negativos leves a moderados" },
      { max: 85, texto: "Sintomas negativos marcados" },
      { max: 125, texto: "Sintomas negativos severos; valorar impacto funcional" }
    ],
    items: [
      { texto: "Expresion facial poco cambiante.", dominio: "Aplanamiento afectivo" },
      { texto: "Disminucion de movimientos espontaneos.", dominio: "Aplanamiento afectivo" },
      { texto: "Pobreza de gestos expresivos.", dominio: "Aplanamiento afectivo" },
      { texto: "Contacto visual pobre.", dominio: "Aplanamiento afectivo" },
      { texto: "Respuesta afectiva reducida.", dominio: "Aplanamiento afectivo" },
      { texto: "Afecto inapropiado.", dominio: "Aplanamiento afectivo" },
      { texto: "Falta de inflexiones vocales.", dominio: "Aplanamiento afectivo" },
      { texto: "Valoracion global de aplanamiento afectivo.", dominio: "Aplanamiento afectivo" },
      { texto: "Pobreza del habla.", dominio: "Alogia" },
      { texto: "Pobreza del contenido del habla.", dominio: "Alogia" },
      { texto: "Bloqueo.", dominio: "Alogia" },
      { texto: "Aumento de latencia de respuesta.", dominio: "Alogia" },
      { texto: "Valoracion global de alogia.", dominio: "Alogia" },
      { texto: "Aseo e higiene reducidos.", dominio: "Avolicion-apatia" },
      { texto: "Impersistencia en trabajo, escuela o tareas.", dominio: "Avolicion-apatia" },
      { texto: "Anergia fisica.", dominio: "Avolicion-apatia" },
      { texto: "Valoracion global de avolicion-apatia.", dominio: "Avolicion-apatia" },
      { texto: "Disminucion de intereses recreativos.", dominio: "Anhedonia-asocialidad" },
      { texto: "Disminucion de interes o actividad sexual.", dominio: "Anhedonia-asocialidad" },
      { texto: "Dificultad para intimidad o cercania.", dominio: "Anhedonia-asocialidad" },
      { texto: "Relaciones con familiares y amigos reducidas.", dominio: "Anhedonia-asocialidad" },
      { texto: "Valoracion global de anhedonia-asocialidad.", dominio: "Anhedonia-asocialidad" },
      { texto: "Inatencion social.", dominio: "Atencion" },
      { texto: "Inatencion durante la evaluacion mental.", dominio: "Atencion" },
      { texto: "Valoracion global de atencion.", dominio: "Atencion" }
    ]
  },
  {
    id: "bprs",
    nombre: "BPRS",
    area: "Psicopatologia general",
    tipoEscala: "psiquiatrica",
    descripcion: "Brief Psychiatric Rating Scale de 18 reactivos para severidad psicopatologica global.",
    introduccion: "Califique de 1 a 7 segun severidad observada o referida en la evaluacion clinica.",
    rango: "18-126",
    puntajeMaximo: 126,
    dominiosEvaluados: ["Afectivo-ansioso", "Psicotico", "Desorganizacion", "Activacion", "Negativo-retardo"],
    opciones: ["No presente", "Muy leve", "Leve", "Moderado", "Moderadamente severo", "Severo", "Extremadamente severo"],
    valores: [1, 2, 3, 4, 5, 6, 7],
    puntosCorte: [
      { max: 31, texto: "Severidad baja o minima; interpretar clinicamente" },
      { max: 40, texto: "Severidad leve" },
      { max: 52, texto: "Severidad moderada" },
      { max: 126, texto: "Severidad marcada a severa" }
    ],
    items: [
      { texto: "Preocupacion somatica.", dominio: "Afectivo-ansioso" },
      { texto: "Ansiedad.", dominio: "Afectivo-ansioso" },
      { texto: "Retraimiento emocional.", dominio: "Negativo-retardo" },
      { texto: "Desorganizacion conceptual.", dominio: "Desorganizacion" },
      { texto: "Sentimientos de culpa.", dominio: "Afectivo-ansioso" },
      { texto: "Tension.", dominio: "Afectivo-ansioso" },
      { texto: "Manierismos y posturas.", dominio: "Desorganizacion" },
      { texto: "Grandiosidad.", dominio: "Psicotico" },
      { texto: "Animo depresivo.", dominio: "Afectivo-ansioso" },
      { texto: "Hostilidad.", dominio: "Activacion" },
      { texto: "Suspicacia.", dominio: "Psicotico" },
      { texto: "Conducta alucinatoria.", dominio: "Psicotico" },
      { texto: "Retardo motor.", dominio: "Negativo-retardo" },
      { texto: "Falta de cooperacion.", dominio: "Activacion" },
      { texto: "Contenido inusual del pensamiento.", dominio: "Psicotico" },
      { texto: "Afecto embotado.", dominio: "Negativo-retardo" },
      { texto: "Excitacion.", dominio: "Activacion" },
      { texto: "Desorientacion.", dominio: "Desorganizacion" }
    ]
  },
  {
    id: "eeag_gaf",
    nombre: "EEAG / GAF",
    area: "Funcionamiento global",
    tipoEscala: "psiquiatrica",
    descripcion: "Escala de Evaluacion de la Actividad Global / Global Assessment of Functioning.",
    introduccion: "Seleccione el puntaje global de funcionamiento de 1 a 100 segun juicio clinico. El sistema muestra el rango e interpretacion correspondiente.",
    rango: "1-100",
    puntajeMaximo: 100,
    dominiosEvaluados: ["Funcionamiento global"],
    puntosCorte: [
      { max: 10, texto: "1-10: peligro persistente de dañar gravemente a si mismo u otros, o incapacidad persistente para mantener higiene minima, o acto suicida grave con expectativa clara de muerte." },
      { max: 20, texto: "11-20: algun peligro de dañar a si mismo u otros, falla ocasional de higiene minima, o deterioro importante de la comunicacion." },
      { max: 30, texto: "21-30: conducta influida por delirios/alucinaciones o deterioro grave de comunicacion/juicio, o incapacidad para funcionar en casi todas las areas." },
      { max: 40, texto: "31-40: alteracion en prueba de realidad/comunicacion o deterioro mayor en varias areas." },
      { max: 50, texto: "41-50: sintomas graves o deterioro grave del funcionamiento social, laboral o escolar." },
      { max: 60, texto: "51-60: sintomas moderados o dificultad moderada en funcionamiento social, laboral o escolar." },
      { max: 70, texto: "61-70: sintomas leves o alguna dificultad funcional, con funcionamiento general relativamente conservado." },
      { max: 80, texto: "71-80: sintomas transitorios o esperables ante estresores; deterioro leve si existe." },
      { max: 90, texto: "81-90: sintomas ausentes o minimos; buen funcionamiento en todas las areas." },
      { max: 100, texto: "91-100: funcionamiento superior en una amplia gama de actividades; sin sintomas." }
    ],
    items: [
      {
        texto: "Puntaje EEAG/GAF global (1-100).",
        dominio: "Funcionamiento global",
        tipo: "numero",
        min: 1,
        max: 100,
        step: 1,
        ayuda: "Seleccione el puntaje total; la interpretacion se calcula por rango."
      }
    ]
  }
];

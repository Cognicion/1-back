...
function perfilMedico(m = {}) { return { uid: m.uid || m.id || "", nombre: m.nombreCompleto || m.nombre || m.displayName || m.email || "", cargo: m.cargo || m.grado || m.especialidad || m.rol || "", cedulaProfesional: m.cedulaProfesional || m.cedula || "", servicio: m.servicio || m.servicioInstitucional || "", firmaId: m.firmaId || "" }; }

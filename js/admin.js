...
function renderizarAccesoMotorPatrones() {
  ...
  seccion.innerHTML = `
    ...
    <div class="patrones-filtros-principales"><div class="patrones-conectores" aria-label="Filtro de conectores"><span class="patrones-control-label">Conectores</span><button id="btnExcluirConectores" type="button" aria-pressed="true">Excluir conectores</button><button id="btnIncluirConectores" type="button" aria-pressed="false">Incluir conectores</button><small>Oculta frases formadas únicamente por palabras funcionales.</small></div><div class="patrones-umbral" aria-label="Configuración del umbral de patrones"><label for="umbralPatronesInput">Umbral de patrón</label><button id="btnUmbralPatronesMenos" type="button" aria-label="Disminuir umbral">−</button><input id="umbralPatronesInput" type="number" min="2" max="1000" step="1" inputmode="numeric" value="3" aria-describedby="ayudaUmbralPatrones"><button id="btnUmbralPatronesMas" type="button" aria-label="Aumentar umbral">+</button><span id="ayudaUmbralPatrones">Mostrar únicamente frases con frecuencia ≥ umbral.</span></div></div>
    <p id="estadoPatronesTexto" class="estado-patrones" aria-live="polite">Módulo listo. No se han leído textos clínicos.</p>
    <div class="patrones-resumen"><span>Umbral actual: <strong id="umbralPatronesTexto">3 apariciones</strong></span><span>Patrones disponibles: <strong id="patronesDisponiblesPatronesTexto">0</strong></span><span>Patrones visibles: <strong id="patronesVisiblesPatronesTexto">0</strong></span><span>Ocultos por conectores: <strong id="patronesOcultosConectoresPatronesTexto">0</strong></span><span>Ocultos por umbral: <strong id="patronesOcultosUmbralPatronesTexto">0</strong></span><span>Frecuencia máxima: <strong id="frecuenciaMaximaPatronesTexto">0</strong></span><span>Frecuencia media: <strong id="frecuenciaMediaPatronesTexto">0</strong></span><span>Documentos revisados: <strong id="documentosPatronesTexto">0</strong></span><span>Lotes procesados: <strong id="lotesPatronesTexto">0</strong></span><span>Candidatas temporales: <strong id="candidatasPatronesTexto">0</strong></span><span>Tiempo: <strong id="tiempoPatronesTexto">0 ms</strong></span></div>
...
async function cargarMotorPatronesBajoDemanda() {
  ...
  if (!patternModulePromise) {
    ...
    patternModulePromise = import("./admin/patternDiscovery/patternDiscoveryController.js?v=20260802-patterns-v4");
  }

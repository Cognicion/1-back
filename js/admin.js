...
function renderizarAccesoMotorPatrones() {
  ...
  seccion.innerHTML = `
    ...
    <div class="patrones-umbral" aria-label="Configuración del umbral de patrones"><label for="umbralPatronesInput">Umbral de patrón</label><button id="btnUmbralPatronesMenos" type="button" aria-label="Disminuir umbral">−</button><input id="umbralPatronesInput" type="number" min="2" max="1000" step="1" inputmode="numeric" value="3" aria-describedby="ayudaUmbralPatrones"><button id="btnUmbralPatronesMas" type="button" aria-label="Aumentar umbral">+</button><span id="ayudaUmbralPatrones">Mostrar únicamente frases con frecuencia ≥ umbral.</span></div>
    <p id="estadoPatronesTexto" class="estado-patrones" aria-live="polite">Módulo listo. No se han leído textos clínicos.</p>
    <div class="patrones-resumen"><span>Umbral actual: <strong id="umbralPatronesTexto">3 apariciones</strong></span><span>Patrones visibles: <strong id="patronesVisiblesPatronesTexto">0</strong></span><span>Frases ocultas: <strong id="patronesOcultosPatronesTexto">0</strong></span><span>Frecuencia máxima: <strong id="frecuenciaMaximaPatronesTexto">0</strong></span><span>Frecuencia media: <strong id="frecuenciaMediaPatronesTexto">0</strong></span><span>Documentos revisados: <strong id="documentosPatronesTexto">0</strong></span><span>Lotes procesados: <strong id="lotesPatronesTexto">0</strong></span><span>Candidatas temporales: <strong id="candidatasPatronesTexto">0</strong></span><span>Patrones disponibles: <strong id="confirmadosPatronesTexto">0</strong></span><span>Tiempo: <strong id="tiempoPatronesTexto">0 ms</strong></span></div>

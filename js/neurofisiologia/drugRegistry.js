export const REGISTRO_FARMACOS_NEURO = [
  ...
  { id: "levetiracetam", nombre: "Levetiracetam", clase: "Modulador SV2A", diana: "SV2A vesicular", inicio: "intermedio", descripcion: "Se representa en SV2A de vesiculas presinapticas; disminuye liberacion excesiva sin bloquear transmision basal.", efectos: { sv2a: 0.36, liberacionAltaFrecuencia: -0.28 } },
  { id: "gabapentina", nombre: "Gabapentina", clase: "Modulador alfa2delta", diana: "subunidad alpha2delta de Cav presinapticos", inicio: "intermedio", descripcion: "Se une a alpha2delta; no bloquea directamente el poro. Reduce entrada funcional de Ca2+ y liberacion excitadora durante estimulacion.", efectos: { bloqueoCa: 0.34, liberacion: -0.22 } },
  { id: "pregabalina", nombre: "Pregabalina", clase: "Modulador alfa2delta", diana: "subunidad alpha2delta de Cav presinapticos", inicio: "intermedio", descripcion: "Se une a alpha2delta; no es bloqueo instantaneo absoluto del canal. Disminuye Ca2+ funcional y probabilidad de liberacion.", efectos: { bloqueoCa: 0.42, liberacion: -0.26 } },
  ...
  { id: "metanfetamina", nombre: "Anfetamina / metanfetamina", clase: "Droga de abuso", diana: "DAT / VMAT2 / liberacion monoaminergica", inicio: "rapido", descripcion: "Modelo educativo: entra por DAT, desplaza monoaminas de vesiculas via VMAT2 y favorece transporte reverso con aumento de neurotransmisor sinaptico.", efectos: { excitabilidad: 0.38, liberacion: 0.34, recaptura: -0.48, datReverso: 0.72, vmat2: -0.55, monoaminaCitoplasmatica: 0.7, umbral: -2 } },

...
function datosGuardables(datos, usuarioUid) {
  ...
  return {
    ...
    ...(datos.detectedEventId ? { detectedEventId: datos.detectedEventId } : {}),
    ...(datos.deteccionId ? { deteccionId: datos.deteccionId } : {}),
    ...(datos.sourceType ? { sourceType: datos.sourceType } : {}),
    ...(datos.sourceId ? { sourceId: datos.sourceId } : {}),
    ...(datos.sourceLabel ? { sourceLabel: datos.sourceLabel } : {}),
    ...(datos.sourceDate ? { sourceDate: datos.sourceDate } : {}),
    ...(typeof datos.fechaEsAproximada === "boolean" ? { fechaEsAproximada: datos.fechaEsAproximada } : {}),
    ...(datos.precisionTemporal ? { precisionTemporal: datos.precisionTemporal } : {}),
    ...(datos.etiquetaTemporal ? { etiquetaTemporal: String(datos.etiquetaTemporal).slice(0, 120) } : {}),
    ...(datos.relacionSujeto ? { relacionSujeto: String(datos.relacionSujeto).slice(0, 80) } : {}),
    ...(datos.contextoClinico ? { contextoClinico: String(datos.contextoClinico).slice(0, 120) } : {}),

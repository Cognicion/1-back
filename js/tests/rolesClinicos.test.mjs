...
const pacientePro = { id: "pacientePro", rol: "paciente", tipoMembresia: "pro" };
...
assert.equal(canAccessService(pacientePro, "admin"), false);
assert.equal(canAccessService(pacientePro, "administracion"), false);
assert.equal(canAccessService(pacientePro, "panel_medico"), false);
assert.equal(canAccessService(pacientePro, "constructor_notas"), true);
assert.equal(canAccessService(pacientePro, ""), false);

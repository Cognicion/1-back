...
test("A-I conservan conteos y contratos clínicos y farmacológicos", () => {
  assert.deepEqual(
  ...
  const entidades = CATALOGO_DIAGNOSTICOS.filter((diagnostico) => /^[A-I]/.test(diagnostico.sistemas?.cie10?.codigo || ""));

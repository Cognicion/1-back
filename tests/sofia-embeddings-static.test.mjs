...
assert.match(adminHtml, /css\/admin\.css\?v=20260819-sofia-embeddings-v1/);
assert.match(adminHtml, /js\/admin\.js\?v=20260819-sofia-embeddings-v1/);
assert.match(adminJs, /clinicalKnowledgeController\.js\?v=20260819-sofia-embeddings-v1/);

...
assert.match(transferIndex, /patientTransferController\.js\?v=v167-enedina-name-diagnosis-boundaries-v1/, "el índice fuerza la carga del controlador publicado");

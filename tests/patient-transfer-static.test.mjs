...
assert.match(transferIndex, /patientTransferController\.js\?v=20260813-diagnosis-context-gate-v1/, "el índice fuerza la carga del controlador publicado");
...
assert.match(controller, /patientTransferView\.js\?v=20260813-diagnosis-context-gate-v1/, "el controlador fuerza la carga de la UI del importador publicada");

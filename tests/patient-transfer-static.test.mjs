...
assert.match(medico, /import\("\.\/modules\/patient-transfer\/index\.js\?v=20260818-diagnoses-studies-v1"\)/, "el módulo activo se carga con lazy loading y versión explícita");
...
assert.match(html, /js\/medico\.js\?v=20260818-diagnoses-studies-v1/, "medico.html solicita la versión vigente del panel");

const appVersion = read("js/config/appVersion.js");
const serviceWorker = read("service-worker.js");
assert.match(appVersion, /APP_VERSION = "2\.025"/, "la versión visible identifica diagnósticos completos y estudios importados");
assert.match(serviceWorker, /CACHE_VERSION = "20260818-diagnoses-studies-v1"/, "el service worker renueva la caché del importador");
...
assert.match(transferIndex, /patientTransferController\.js\?v=20260818-diagnoses-studies-v1/, "el índice fuerza la carga del controlador publicado");
...
assert.match(controller, /patientTransferRepository\.js\?v=20260818-diagnoses-studies-v1/, "el controlador carga el repositorio corregido");
...
assert.match(controller, /clinicalCandidateParser\.js\?v=20260818-diagnoses-studies-v1/, "el controlador carga los candidatos clínicos corregidos");
assert.match(controller, /treatmentPlanAdapter\.js\?v=20260817-medication-fraction-doses-v1/, "el controlador carga el adaptador farmacológico corregido");
...
assert.match(treatmentPlanAdapter, /treatmentPlanParser\.js\?v=20260817-medication-fraction-doses-v1/, "el adaptador carga el parser de Plan vigente");
...
assert.match(treatmentPlanParser, /medicationNormalizer\.js\?v=20260817-medication-fraction-doses-v1/, "el parser de Plan usa límites farmacológicos vigentes");
assert.match(treatmentPlanParser, /medicationParser\.js\?v=20260817-medication-fraction-doses-v1/, "el parser de Plan usa el parser farmacológico vigente");
...
assert.match(medicationParser, /medicationNormalizer\.js\?v=20260817-medication-fraction-doses-v1/, "el parser usa el normalizador farmacológico corregido");
assert.match(controller, /patientTransferView\.js\?v=20260818-diagnoses-studies-v1/, "el controlador fuerza la carga de diagnósticos y estudios actualizados");

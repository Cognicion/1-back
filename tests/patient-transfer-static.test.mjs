...
assert.match(medico, /import\("\.\/modules\/patient-transfer\/index\.js\?v=20260818-admission-date-v1"\)/, "el módulo activo se carga con lazy loading y versión explícita");
...
assert.match(html, /js\/medico\.js\?v=20260818-admission-date-v1/, "medico.html solicita la versión vigente del panel");
...
assert.match(transferIndex, /patientTransferController\.js\?v=20260818-admission-date-v1/, "el índice fuerza la carga del controlador publicado");
...
assert.match(controller, /patientTransferView\.js\?v=20260818-admission-date-v1/, "el controlador fuerza la carga de la fecha de ingreso actualizada");

...
assert.match(transferIndex, /patientTransferController\.js\?v=v173-compact-indications-v1/, "el índice fuerza la carga del controlador publicado");
...
assert.match(controller, /patientTransferView\.js\?v=v164-compact-indications-v1/, "el controlador fuerza la carga de la UI compacta");

...
assert.match(medico, /import\("\.\/modules\/patient-transfer\/index\.js\?v=20260819-midc-allergy-context-v1"\)/, "el módulo activo se carga con lazy loading y versión explícita");

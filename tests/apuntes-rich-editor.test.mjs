...
test("el HTML ofrece carpetas, formato accesible y accesos globales integrados", () => {
  ...
  assert.match(html, /theme-preload\.js\?v=2\.206-navbar-agenda-v1/);
  ...
  assert.match(precargaTema, /globalAppHeader\.js\?v=2\.206-navbar-agenda-v1/);
...
test("el editor flotante invalida formato solo cuando cambia el contenido", () => {
  ...
  assert.match(nota, /nota\.js\?v=20260904-parametros-colera-v2/);
  assert.match(paciente, /paciente\.js\?v=20260911-modafinil-substances-lab-v1/);
});

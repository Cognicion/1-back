...
test("sofia.html carga y expone el panel ECG", async () => {
  ...
  assert.match(html, /sofia\.js\?v=20260911-modafinil-substances-lab-v1/);
  assert.match(html, /sofia\.css\?v=20260908-sofia-admin-analysis-v1/);
  assert.match(appVersion, /APP_VERSION\s*=\s*"2\.210"/);
});
